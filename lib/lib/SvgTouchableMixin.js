Object.defineProperty(exports,"__esModule",{value:true});var _extends=Object.assign||function(target){for(var i=1;i<arguments.length;i++){var source=arguments[i];for(var key in source){if(Object.prototype.hasOwnProperty.call(source,key)){target[key]=source[key];}}}return target;};var _Touchable=require('react-native/Libraries/Components/Touchable/Touchable');var _Touchable2=_interopRequireDefault(_Touchable);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
var PRESS_RETENTION_OFFSET={top:20,left:20,right:20,bottom:30};exports.default=_extends({},


_Touchable2.default.Mixin,{
...
return this.props.onStartShouldSetResponder(e);}else 
{
...
return this.props.onResponderTerminationRequest(e);}else 
{
...
return this.props.onResponderGrant(e);}else 
{
...
return this.props.onResponderMove(e);}else 
{
...
return this.props.onResponderRelease(e);}else 
{
...
return this.props.onResponderTerminate(e);}else 
{
