Object.defineProperty(exports,"__esModule",{value:true});var _react=require('react');
var _percentToFloat=require('../lib/percentToFloat');var _percentToFloat2=_interopRequireDefault(_percentToFloat);
var _Stop=require('./Stop');var _Stop2=_interopRequireDefault(_Stop);
var _color=require('color');var _color2=_interopRequireDefault(_color);
var _extractOpacity=require('../lib/extract/extractOpacity');var _extractOpacity2=_interopRequireDefault(_extractOpacity);
...
Gradient=function(_Component){_inherits(Gradient,_Component);function Gradient(){var _Object$getPrototypeO;var _temp,_this,_ret;_classCallCheck(this,Gradient);for(var _len=arguments.length,args=Array(_len),_key=0;_key<_len;_key++){args[_key]=arguments[_key];}return _ret=(_temp=(_this=_possibleConstructorReturn(this,(_Object$getPrototypeO=Object.getPrototypeOf(Gradient)).call.apply(_Object$getPrototypeO,[this].concat(args))),_this),_this.
...
// add stop
stops[offset]=(0,_color2.default)(child.props.stopColor).alpha((0,_extractOpacity2.default)(child.props.stopOpacity));}}else 
...
return gradient;},_temp),_possibleConstructorReturn(_this,_ret);}return Gradient;}(_react.Component);Gradient.displayName='Gradient';exports.default=
